...
const EditPost = () => {
    ...
    return (
        ...
        <div className='px-6 md:px-[200px] mt-8'>
            <h1 className='font-bold md:2xl text-xl mt-8'>Update a post</h1>
        <form className='w-full flex flex-col spzce-y-4 md:space-y-8 mt-4'>
            ...
            <button className='bg-black w-full md:w-[20%] text-white mx-auto font-semibold px-4 py-2 md:text-xl text-lg'>Update</button>
        </form>
        </div>
        <Footer />
    </div>
